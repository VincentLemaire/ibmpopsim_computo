...
print(paste("Execution time : ", sim_out$logs[["duration_ns"]]/1e9, "s", sep="")) 

print(paste("Proportion of effective events and proposed events : ", sim_out$logs[["effective_events"]] / sim_out$logs[["proposed_events"]], sep="")) 
